...
import com.scube.edu.service.RequestTypeService;
...
public class RequestTypeController {
	...
	public ResponseEntity<Object> getList(HttpServletRequest request) {
		...
		try {
			...
			logger.info("---RequestTypeController -------- getList------");
            List<RequestTypeResponse> responseData = reqTypeService.getRequestTypeList(request);
