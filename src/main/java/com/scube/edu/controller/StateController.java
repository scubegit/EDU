...
import com.scube.edu.service.StateService;
...
public class StateController {
	...
	public ResponseEntity<Object> getStateList(@PathVariable Long id,HttpServletRequest request) {
		...
		try {
            ...
            List<StateResponse> responseData = stateService.getStateList(id,request);
