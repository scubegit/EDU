...
import com.scube.edu.service.DistrictService;
...
public class DistrictController {
	...
	@GetMapping("/getdistrictList/{id}")
	public ResponseEntity<Object> getDistrictList(@PathVariable Long id,HttpServletRequest request) {
		...
		try {
            ...
            List<DistrictResponse> responseData = districtService.getDistrictList(id,request);
